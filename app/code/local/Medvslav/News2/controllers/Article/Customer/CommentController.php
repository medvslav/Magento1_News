 ...
 * @author      Medvslav
 */
class Medvslav_News2_Article_Customer_CommentController extends Mage_Core_Controller_Front_Action
{
    /**
     * Action predispatch
    ...
    public function indexAction()
    {
        ...
        if ($navigationBlock = $this->getLayout()->getBlock('customer_account_navigation')) {
            $navigationBlock->setActive('medvslav_news2/article_customer_comment/');
        }
    ...
    public function viewAction()
    {
        ...
        $comment = Mage::getModel('medvslav_news2/article_comment')->load($commentId);
        if (!$comment->getId() ||
            $comment->getCustomerId() != Mage::getSingleton('customer/session')->getCustomerId() ||
            $comment->getStatus() != Medvslav_News2_Model_Article_Comment::STATUS_APPROVED) {
