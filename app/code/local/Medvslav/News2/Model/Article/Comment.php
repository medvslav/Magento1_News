 ...
 * @author      Medvslav
 */
class Medvslav_News2_Model_Article_Comment extends Mage_Core_Model_Abstract
{
     ...
     */
    const ENTITY    = 'medvslav_news2_article_comment';
    const CACHE_TAG = 'medvslav_news2_article_comment';
    /**
     * Prefix of model events names
     * @var string
     */
    protected $_eventPrefix = 'medvslav_news2_article_comment';
