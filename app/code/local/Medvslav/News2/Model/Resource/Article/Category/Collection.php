 ...
 * @author      Medvslav
 */
class Medvslav_News2_Model_Resource_Article_Category_Collection extends Mage_Catalog_Model_Resource_Category_Collection
{
    /**
    ...
    public function joinFields()
    {
        if (!$this->_joinedFields) {
            $this->getSelect()->join(
                array('related' => $this->getTable('medvslav_news2/article_category')),
