 ...
 * @author      Medvslav
 */
class Medvslav_News2_Model_Resource_Article_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                array('store_table' => $this->getTable('medvslav_news2/article_store')),
    ...
    public function addProductFilter($product)
    {
        ...
        if (!isset($this->_joinedFields['product'])) {
            $this->getSelect()->join(
                array('related_product' => $this->getTable('medvslav_news2/article_product')),
    ...
    public function addCategoryFilter($category)
    {
        ...
        if (!isset($this->_joinedFields['category'])) {
            $this->getSelect()->join(
                array('related_category' => $this->getTable('medvslav_news2/article_category')),
