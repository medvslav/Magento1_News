 ...
 * @author      Medvslav
 */
class Medvslav_News2_Model_Resource_Article_Comment_Article_Collection extends Medvslav_News2_Model_Resource_Article_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('medvslav_news2/article_comment_store');
    }
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('medvslav_news2/article_comment');
        $this->getSelect()->join(
            array('ct' => $commentTable),
            'ct.article_id = main_table.entity_id',
            array(
                'ct_title'      => 'title',
