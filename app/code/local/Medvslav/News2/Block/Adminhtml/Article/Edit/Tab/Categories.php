 ...
 */
/**
 * article - categories relation edit block
 *
 * @category    Medvslav
 * @package     Medvslav_News2
 * @author      Medvslav
 */
class Medvslav_News2_Block_Adminhtml_Article_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('medvslav_news2/article/edit/tab/categories.phtml');
    ...
    /**
     * Return array with categories IDs which the article is linked to
     *
     * @access public
     * @return array
     * @author Medvslav
    ...
    public function getCategoryIds()
    {
        if (is_null($this->_categoryIds)) {
            $categories = $this->getArticle()->getSelectedCategories();
            $ids = array();
     ...
     * Returns root node
     *
     * @param Medvslav_News2_Model_Category|null $parentNodeCategory
