 ...
 * @author      Medvslav
 */
class Medvslav_News2_Block_Adminhtml_Article_Edit_Tab_Product extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
     ...
     *
     * @access protected
     * @return Medvslav_News2_Block_Adminhtml_Article_Edit_Tab_Product
     * @author Medvslav
     */
     ...
     *
     * @access public
     * @param Medvslav_News2_Model_Product
     * @return string
     * @author Medvslav
     */
